...
do_subm = True #int(sys.argv[3]) removed 5/3/2016
if do_subm:
...
timeLog = open(prefix_path + 'elapsed.txt', 'wb')
timeLog.write("Time running: " + str(elapsedTime))
timeLog.close()

print "elapsed time of testing: " + str(elapsedTime)
